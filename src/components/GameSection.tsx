...
const questions: Question[] = [
  ...
  { sender: "Досым Арман", avatar: "ДА", avatarColor: "#E65100", isBank: false, message: "Бауырым, ертең той. Kazmeat дүкенінен 10 кг сиыр еті алдым, бірге барамыз ба? 1 кг 5 000 теңгеден тұр екен.", isFraud: false, explanation: "Қарапайым хабарлама. Достан ет туралы хабар — алаяқтық белгілері жоқ." },
