const members = [
  { initials: "АА", name: "Айгерім Асанова", role: "Жоба жетекшісі", color: "#C62828", quote: "«Әжем алаяқтарға ақша аударып жібергенде, бұл жобаның қаншалықты маңызды екенін түсіндім.»" },
  ...
  { initials: "ДС", name: "Дана Сейткәлі", role: "Дизайнер", color: "#2E7D32", quote: "«Ақпарат болғаны жеткіліксіз — оны адам оқығысы келетіндей етіп жасау керек.»" },
  ...
  { initials: "НИ", name: "Нұрлан Ибраһим", role: "Техникалық жасаушы", color: "#E65100", quote: "«Код арқылы қоғамға пайда келтіруге болатынына осы жоба — тірі дәлел.»" },
  { initials: "МК", name: "Мадина Қалиева", role: "Деректер аналитигі", color: "#00695C", quote: "«Сандардың артында нақты адамдар бар. Соны ұмытпасақ болғаны.»" },
];
